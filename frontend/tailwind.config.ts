...
const config: Config = {
	...
	theme: {
		extend: {
			colors: {
				// Primary — Gold accent. Base darkened to #8B6914 for WCAG AA contrast
				// (5.1:1 on white) — serves both text and button-fill use cases.
				// Kept in sync with styles/tokens.css (single source of truth for hex).
				primary: {
					DEFAULT: "#8B6914",
					hover: "#7D5D07",
					active: "#6B4F04",
