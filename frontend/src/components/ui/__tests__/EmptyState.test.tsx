...
describe("EmptyState", () => {
	...
	it("should render data type", () => {
		...
		expect(
			screen.getByText("Start by adding your first time series or importing existing data."),
		).toBeInTheDocument();
	});
	...
	it("should render datasets type", () => {
		...
		expect(
			screen.getByText("Create your first dataset to organize and manage your time series data."),
		).toBeInTheDocument();
	});
	...
	it("should render timeseries type", () => {
		...
		expect(
			screen.getByText("Create a time series to start collecting and analyzing your data."),
		).toBeInTheDocument();
	});
	...
	it("should render alerts type", () => {
		...
		expect(
			screen.getByText("You're all caught up! No alerts need your attention right now."),
		).toBeInTheDocument();
	});
	...
	it("should render anomalies type", () => {
		...
		expect(
			screen.getByText("Great! Your data looks normal. No anomalies have been detected."),
		).toBeInTheDocument();
	});
	...
	it("should render forecasts type", () => {
		...
		expect(
			screen.getByText("Create AI-powered forecasts to predict future trends in your data."),
		).toBeInTheDocument();
	});
	...
	it("should render errors type", () => {
		...
		expect(
			screen.getByText("Everything is running smoothly. No errors to display."),
		).toBeInTheDocument();
	});
	...
	it("should render action button when both actionText and onAction are provided", () => {
		...
		render(<EmptyState actionText="Create Item" onAction={handleClick} />);
