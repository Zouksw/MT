...
describe('StatCard', () => {
  ...
  it('should render trend indicator with positive value', () => {
    render(
      <StatCard title="Revenue" value={50000} trend={{ value: 12.5, isPositive: true }} />
    );
  ...
  it('should render trend indicator with negative value', () => {
    render(
      <StatCard title="Expenses" value={3000} trend={{ value: 5.2, isPositive: false }} />
    );
  ...
  it('should render trend indicator with zero value', () => {
    render(
      <StatCard title="Steady" value={100} trend={{ value: 0, isPositive: true }} />
    );
    expect(screen.getByText('+0%')).toBeInTheDocument();
  });
