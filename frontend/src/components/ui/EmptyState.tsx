...
import { BarChart3, Database, Activity, Bell, Search, TrendingUp, Inbox } from "lucide-react";
...
const illustrationMap: Record<EmptyStateType, { title: string; description: string; icon: React.ReactNode; color: string; bgColor: string }> = {
  default: {
