...
import type { IChartApi, UTCTimestamp, LineData, DeepPartial, ChartOptions } from "lightweight-charts";
...
export default function MultiSourceChart({ sources, height = 400 }: MultiSourceChartProps) {
  ...
  useEffect(() => {
    ...
    const colorList = ["#8B5CF6", "#F59E0B", "#10B981", "#3B82F6", "#EF4444", "#14B8A6", "#F97316", "#EC4899"];
