...
export default function AlertCreate() {
	...
	// Get timeseries list
	const { data: timeseriesList } = useList<{ id: string; name: string; unit?: string }>(
		"timeseries",
		{
			pageSize: 1000,
			sort: "name",
	...
	const timeseriesOptions = timeseriesList.map(
		(ts: { id: string; name: string; unit?: string }) => ({
			value: ts.id,
	...
	return (
		<div className="min-h-screen bg-muted p-4 md:p-6">
			<div className="mx-auto max-w-3xl">
				...
				<div className="flex items-start justify-between gap-4 mb-6">
					<div>
						...
						<p className="text-sm text-muted-foreground mt-1">
							Configure a new alert for monitoring your time series data
						</p>
					</div>
				...
				<div className="mb-6">
					<Alert variant="info">
						Configure alerts to notify you when specific events occur in your time series data.
						Alerts can be sent via email, webhook, or viewed in the alerts dashboard.
					</Alert>
				</div>
