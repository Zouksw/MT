...
import { Pencil, Download, Trash2, Database, Plus } from "lucide-react";
...
function StatDisplay({ label, value, suffix, icon }: { label: string; value: string | number; suffix?: string; icon?: React.ReactNode }) {
  return (
      ...
      <div className="mx-auto max-w-[1440px]">
        ...
        <div className="mb-6">
          <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-3">
            ...
            <span>/</span>
            <a href="/datasets" className="hover:text-gray-700 dark:hover:text-gray-200">Datasets</a>
            <span>/</span>
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              <h1 className="text-2xl font-semibold text-foreground tracking-tight">{dataset.name}</h1>
              {dataset.description && (
            ...
            <CardBody className="p-0">
              {timeseries.length === 0 ? (
                <div className="text-center py-12">
                  <p className="text-muted-foreground">No time series associated with this dataset.</p>
                </div>
              ) : (
                <Table
                  columns={tsColumns}
            ...
            <Card>
              ...
              <CardBody>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <StatDisplay label="Storage Used" value={`${(dataset.sizeMB || 0).toFixed(2)} MB`} />
                  <StatDisplay label="Last Import" value={dataset.lastImport ? "Recently" : "Never"} />
                </div>
              </CardBody>
            </Card>
          </div>
        ...
        >
          <p className="text-gray-600 dark:text-gray-300">
            Are you sure you want to delete this dataset? This action cannot be undone and will remove all associated time series and data points.
          </p>
        </Modal>
      </div>
    </div>
