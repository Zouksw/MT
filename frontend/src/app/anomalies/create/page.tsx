  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.showSuccess(
        ...
        "The anomaly record has been created."
      );
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 p-6">
      <div className="mx-auto max-w-[900px]">
        ...
        <Alert variant="info" title="Manual Anomaly Entry" className="mb-6">
          This form allows you to manually record anomalies that were detected
          outside the automated system. Use this for documenting known issues or
          manually identified anomalies.
        </Alert>
