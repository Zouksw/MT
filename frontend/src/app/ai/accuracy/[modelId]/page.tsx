...
import { ArrowLeft, BarChart3, Minus, Target, TrendingDown, TrendingUp } from "lucide-react";
			...
			<LoadingState loading={loading} skeletonType="stats">
				<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
					<StatCard
						title="7-Day MAPE"
						value={
							window7?.mape !== null && window7?.mape !== undefined
								? Number(window7.mape.toFixed(1))
								: "--"
						}
					...
					<StatCard
						title="30-Day MAPE"
						value={
							window30?.mape !== null && window30?.mape !== undefined
								? Number(window30.mape.toFixed(1))
								: "--"
						}
					...
					<StatCard
						title="90-Day MAPE"
						value={
							window90?.mape !== null && window90?.mape !== undefined
								? Number(window90.mape.toFixed(1))
								: "--"
						}
						icon={<BarChart3 className="size-5" />}
						variant="default"
					...
					<StatCard
						...
						variant={
							backtest?.trend === "improving"
								? "success"
								: backtest?.trend === "degrading"
									? "error"
									: "default"
						}
					/>
