...
import { FlaskConical, TrendingUp, AlertTriangle, Brain, ChevronRight } from "lucide-react";
    ...
    <PageContainer>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {aiSections.map((section) => (
          ...
          >
            <div className={`w-12 h-12 rounded-lg bg-gradient-to-br ${section.color} flex items-center justify-center text-white shadow-sm flex-shrink-0 transition-transform duration-200 group-hover:scale-110`}>
              {section.icon}
            </div>
