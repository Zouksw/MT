	...
	return (
		<PageContainer>
			...
			<Alert variant="info" className="mb-6">
				Email Notifications — Configure which events you want to be notified about via email.
			</Alert>
				...
				<div className="space-y-4">
					...
					<div className="flex items-center justify-between">
						...
						<Toggle
							...
							onChange={(v) => updateEmail("alerts", v)}
					...
					<div className="flex items-center justify-between">
						...
						<Toggle
							checked={preferences.email.anomalies}
							onChange={(v) => updateEmail("anomalies", v)}
							label="Anomaly detection notifications"
						/>
					</div>
					...
					<div className="flex items-center justify-between">
						...
						<Toggle
							checked={preferences.email.forecasts}
							onChange={(v) => updateEmail("forecasts", v)}
							label="Forecast result notifications"
						/>
					</div>
				</div>
			</ContentCard>
