	...
	return (
		<div className="min-h-screen flex items-center justify-center bg-gray-50 p-6">
			<div className="relative z-10 max-w-[600px] text-center">
				...
				<h1 className="text-gray-900 text-[clamp(32px,5vw,48px)] font-semibold mb-4 leading-tight">
					Application Error
				</h1>
				<p className="text-lg text-gray-600 mb-10 leading-relaxed">
					Something went wrong while loading this page. Please try again or contact support if the
					problem persists.
				</p>

				{process.env.NODE_ENV === "development" && error.message && (
					<div className="bg-gray-100 rounded-lg p-4 mb-8 text-left border">
						<p className="text-[13px] text-gray-600 font-mono whitespace-pre-wrap break-words m-0">
							{error.message}
						</p>
						{error.digest && (
							<p className="text-xs text-gray-400 font-mono mt-2 m-0">Error ID: {error.digest}</p>
						)}
					</div>
				)}
