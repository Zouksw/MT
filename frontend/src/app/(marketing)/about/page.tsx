...
import { MotionReveal, StaggerContainer, StaggerChild } from "@/components/ui/MotionReveal";
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center gap-8">
              <Link href="/" className="text-body text-muted-foreground hover:text-primary transition-colors">
                Home
              </Link>
      ...
      <section className="py-24 md:py-36 lg:py-48 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <MotionReveal delay={0.1}>
            <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-semibold text-foreground tracking-tight" style={{ letterSpacing: "-0.04em" }}>
          ...
          <MotionReveal delay={0.2}>
            <p className="text-body-lg text-muted-foreground leading-relaxed max-w-2xl mt-6">
              MT provides commodity market intelligence through real-time data,
              multi-factor analysis, and AI-driven price signals. We help analysts and
              institutions make sense of complex, interconnected commodity markets.
            </p>
          </MotionReveal>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-5 gap-12 lg:gap-16 items-center">
            <div className="md:col-span-3">
              <MotionReveal>
                <h2 className="text-h1 font-display text-foreground mb-6" style={{ letterSpacing: "-0.04em" }}>
                  Our Mission
                </h2>
              </MotionReveal>
              <MotionReveal delay={0.1}>
                <p className="text-body text-muted-foreground mb-4 leading-relaxed">
                  MT makes commodity market analysis transparent and accessible.
                  We believe that understanding the factors behind price movements — from
                  weather patterns to shipping costs — should not require a team of quants.
                </p>
              </MotionReveal>
              <MotionReveal delay={0.15}>
                <p className="text-body text-muted-foreground leading-relaxed">
                  By running 7 independent AI models on each commodity, we provide not just
                  predictions but a spectrum of signals with confidence scores. Our platform
                  helps you understand what drives markets, not just where prices are heading.
                </p>
              </MotionReveal>
            </div>
      ...
      <section className="py-24 md:py-36 lg:py-48 px-4 sm:px-6 lg:px-8 bg-gray-50 dark:bg-gray-800">
        <div className="max-w-7xl mx-auto">
          <div className="mb-12 max-w-2xl">
            <MotionReveal>
              <h2 className="text-h1 font-display text-foreground mb-4" style={{ letterSpacing: "-0.04em" }}>
                Core Values
              </h2>
            </MotionReveal>
            <MotionReveal delay={0.1}>
            ...
            {[
              {
                ...
                description: "We filter market chaos into actionable signals. Every feature we ship must help users make better decisions, not just display more data.",
                Icon: ShieldCheck,
                span: "md:col-span-2",
              },
              {
                ...
                description: "Every AI prediction comes with confidence scores, model comparison, and factor attribution. We never ask users to trust a black box.",
                Icon: Lightning,
                span: "",
              },
              {
                ...
                description: "We build what analysts and traders actually need, not what looks impressive in a demo. Our roadmap is shaped by the people who use the platform daily.",
                Icon: Users,
                span: "",
              },
            ].map((value, idx) => (
              <StaggerChild key={idx} className={value.span}>
                ...
                >
                  ...
                  <div className="relative z-10">
                    <div className={`w-12 h-12 rounded-lg bg-primary flex items-center justify-center mb-4 transition-transform duration-200 group-hover:scale-110`}>
            ...
            <StaggerChild className="md:col-span-3 md:row-span-2">
              <div className="bg-white dark:bg-gray-900 rounded-2xl overflow-hidden group transition-all duration-300 outline outline-black/5 dark:outline-white/10 h-full flex flex-col md:flex-row">
                ...
                <div className="md:w-3/5 px-8 py-8 md:px-10 md:py-12 flex flex-col justify-center">
                  ...
                  <p className="text-body text-muted-foreground leading-relaxed">
                    Former head of commodity analytics at a top-5 agricultural trading firm. 12 years of experience bridging quantitative analysis with commercial strategy.
                  </p>
                </div>
              </div>
            </StaggerChild>
              ...
              <div className="bg-white dark:bg-gray-900 rounded-2xl overflow-hidden group transition-all duration-300 outline outline-black/5 dark:outline-white/10 h-full flex items-start gap-5 p-6">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-body-sm text-muted-foreground leading-relaxed">
                    PhD in time-series forecasting from ETH Zurich. Previously built ML infrastructure at a Series-C climate analytics startup serving 200+ enterprise clients.
                  </p>
                </div>
              </div>
            </StaggerChild>
            ...
            <StaggerChild className="md:col-span-2">
              <div className="bg-white dark:bg-gray-900 rounded-2xl overflow-hidden group transition-all duration-300 outline outline-black/5 dark:outline-white/10 h-full flex items-start gap-5 p-6">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-body-sm text-muted-foreground leading-relaxed">
                    Former principal engineer at Bloomberg, responsible for real-time data pipeline architecture handling 500k+ events per second across 40 markets.
                  </p>
                </div>
              </div>
            </StaggerChild>
      ...
      <section className="relative py-24 md:py-36 lg:py-48 px-4 sm:px-6 lg:px-8 overflow-hidden bg-gray-900 dark:bg-gray-800">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <MotionReveal>
            <h2 className="text-h1 font-display text-white mb-6" style={{ letterSpacing: "-0.04em" }}>
