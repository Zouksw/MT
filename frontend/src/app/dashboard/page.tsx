...
import { Database, Activity, TrendingUp, Bell, Lock, User, Star } from "lucide-react";
      ...
      <LoadingState loading={loading} timeout={15000}>
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
          ...
          <div
            ...
            style={{ width: isMobile ? 40 : 48, height: isMobile ? 40 : 48, minWidth: isMobile ? 40 : 48 }}
          >
            {user?.avatar ? (
        ...
        <div className={`grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-4 md:mb-6`} aria-live="polite" aria-atomic="true">
        ...
        {stats?.aiModels && (
          <div className={isMobile ? "mt-4" : "mt-6"}>
            <div
              className="rounded-lg p-5 sm:p-6 text-white relative overflow-hidden bg-[#171717]"
            >
              ...
              <div className="relative z-10 flex items-center justify-between gap-4 flex-wrap">
                <div>
                  ...
                  <p className="text-body text-white/85">
                    <span className="font-mono tabular-nums">{stats.aiModels.active}</span> of <span className="font-mono tabular-nums">{stats.aiModels.total}</span> models active
                  </p>
                </div>
