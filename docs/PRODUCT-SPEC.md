...
| 对华贸易流量层（FOB/CIF 双轨） | `comtrade_mirror`（UN Comtrade 免 key：partner 月度 FOB 镜像 BR/AU/NZ/US + AR/UY 年度回退 + 中国年度 CIF 校准）+ `comext_eu`（Eurostat 免 key：欧盟 IE/NL/FR/PL 月度 **FOB-EUR** 镜像，round-161 双币呈现不合并）+ `argentina_exports`（SSPM ica_carnes 月度 FOB）+ `inac_expo`（INAC eDIAE 乌拉圭官方：对华月度 FOB 金额 + 冻/冷部位族 FOB USD/kg 全球口径，round-162 批 1）+ `indec_comex`（INDEC COMEX 阿根廷官方：对华月度 NCM8 量价，NCM8/HS6/HS4 三层落地，round-163 批 1）落库 MarketFactor；读侧 `GET /api/market/trade-flows`（8 HS 码 + Comext CN8 + INDEC NCM8 码，USD/EUR 每行币别；CN8 round-162 批 2 / NCM8 round-163 批 1）+ /beef 对华贸易流卡（round-152 批 0/2/4、round-161 批 1、round-162 批 1/2） | ✅ 已上线：FOB（partner 口径 USD / 欧盟口径 EUR）与 CIF（中国口径）分轨呈现、口径注记随载荷、**绝不合并**；AR 月度 NCM×目的国交叉经 INDEC COMEX 官方通道补齐（round-163，SSPM 75/77 缺口登记关闭）；到岸成本工具另挂 Drewry WCI 周度海运参照（USD/40ft，round-161 批 2） |
