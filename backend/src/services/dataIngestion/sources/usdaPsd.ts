...
const PSD_COMMODITIES: Record<string, { commodityName: string; factors: string[] }> = {
  '0410000': { commodityName: 'Wheat',     factors: ['production', 'total_consumption', 'exports', 'imports', 'ending_stocks'] },
  '0420000': { commodityName: 'Rice',      factors: ['production', 'total_consumption', 'exports', 'imports', 'ending_stocks'] },
  '0440000': { commodityName: 'Corn',      factors: ['production', 'total_consumption', 'exports', 'imports', 'ending_stocks'] },
  '0450000': { commodityName: 'Barley',    factors: ['production', 'total_consumption', 'exports', 'imports', 'ending_stocks'] },
  '0460000': { commodityName: 'Sorghum',   factors: ['production', 'total_consumption', 'exports', 'imports', 'ending_stocks'] },
  '0230000': { commodityName: 'Beef',      factors: ['production', 'total_consumption', 'exports', 'imports'] },
  '0240000': { commodityName: 'Pork',      factors: ['production', 'total_consumption', 'exports', 'imports'] },
  '0350000': { commodityName: 'Chicken',   factors: ['production', 'total_consumption', 'exports', 'imports'] },
  '0813400': { commodityName: 'Soybeans',  factors: ['production', 'total_consumption', 'exports', 'imports', 'ending_stocks'] },
  '0813700': { commodityName: 'Soybean Meal', factors: ['production', 'total_consumption', 'exports', 'imports'] },
  '0813600': { commodityName: 'Soybean Oil',  factors: ['production', 'total_consumption', 'exports', 'imports'] },
  '2220000': { commodityName: 'Cotton',    factors: ['production', 'total_consumption', 'exports', 'imports', 'ending_stocks'] },
};

// Key countries/regions to track
const KEY_COUNTRIES = ['World', 'United States', 'China', 'Brazil', 'Argentina', 'Australia', 'European Union', 'India', 'Canada', 'Russia'];
...
async function fetchPSDData(): Promise<ScraperResult> {
  ...
  for (const [commodityCode, config] of Object.entries(PSD_COMMODITIES)) {
    try {
      ...
      const latestYear = records.reduce((max, r) =>
        r.marketYear > max ? r.marketYear : max, '',
      );
      ...
      logger.warn(`[USDA_PSD] ${commodityCode} failed: ${err instanceof Error ? err.message : err}`);
    }
  }
