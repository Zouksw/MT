...
const FRED_SERIES: Record<string, {
  name: string;
  frequency: 'daily' | 'weekly' | 'monthly';
  unit: string;
}> = {
  // Commodity indices
  PALLFNFINDEX:   { name: 'Global Price Index of All Commodities',  frequency: 'monthly', unit: 'index' },
  PCOPPUSD:       { name: 'Global Copper Price',                    frequency: 'monthly', unit: 'USD/ton' },
  PSOYBUSDM:      { name: 'Global Soybeans Price',                  frequency: 'monthly', unit: 'USD/ton' },
  PWHEAMTUSD:     { name: 'Global Wheat Price',                     frequency: 'monthly', unit: 'USD/ton' },
  PCOTTIND:       { name: 'Global Cotton Price',                    frequency: 'monthly', unit: 'USD/kg' },
  PSUGAUSA:       { name: 'US Sugar Price',                         frequency: 'monthly', unit: 'USD/kg' },

  // Economic indicators
  CPIAUCSL:       { name: 'Consumer Price Index (CPI)',             frequency: 'monthly', unit: 'index' },
  PPIACO:         { name: 'Producer Price Index (PPI)',             frequency: 'monthly', unit: 'index' },
  DCOILWTICO:     { name: 'Crude Oil WTI',                          frequency: 'daily',   unit: 'USD/bbl' },
  DCOILBRENTEU:   { name: 'Crude Oil Brent',                        frequency: 'daily',   unit: 'USD/bbl' },
  DEXUSEU:        { name: 'USD/EUR Exchange Rate',                  frequency: 'daily',   unit: 'EUR/USD' },
  DEXCHUS:        { name: 'CNY/USD Exchange Rate',                  frequency: 'daily',   unit: 'CNY/USD' },
  DEXBZUS:        { name: 'BRL/USD Exchange Rate',                  frequency: 'daily',   unit: 'BRL/USD' },
  T10Y2Y:         { name: '10Y-2Y Treasury Spread',                 frequency: 'daily',   unit: 'percent' },
