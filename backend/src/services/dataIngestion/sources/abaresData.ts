...
> = {
	beef_production: {
		name: "Australian Beef Production",
		unit: "1000 tonnes",
		category: "beef",
	},
	beef_exports: {
	...
	cattle_herd: {
		name: "Australian Cattle Herd",
		unit: "million head",
		category: "beef",
	},
	slaughter_rate: {
		name: "Australian Cattle Slaughter Rate",
		unit: "1000 head/week",
		category: "beef",
	},
	lamb_production: {
		name: "Australian Lamb Production",
		unit: "1000 tonnes",
		category: "lamb",
	},
	lamb_exports: {
		name: "Australian Lamb Exports",
		unit: "1000 tonnes",
		category: "lamb",
	},
	sheep_herd: {
		name: "Australian Sheep Flock",
		unit: "million head",
		category: "lamb",
	},
	wheat_production: {
		name: "Australian Wheat Production",
		unit: "million tonnes",
		category: "grain",
	},
	wheat_exports: {
		name: "Australian Wheat Exports",
		unit: "million tonnes",
		category: "grain",
	},
};
...
const ABARES_ESTIMATES: Record<
	string,
	Array<{ year: number; quarter: number; value: number }>
> = {
	beef_production: [
	...
	async function insertEstimates(): Promise<ScraperResult> {
		for (const [metricKey, config] of Object.entries(ABARES_METRICS)) {
			...
			for (const est of estimates) {
				...
				const date = new Date(
					`${est.year}-${String(month).padStart(2, "0")}-01T00:00:00Z`,
				);
